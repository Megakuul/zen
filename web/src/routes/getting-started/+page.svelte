...
>
  ...
  <p>
    ...
    one you intended (e.g. you planned to write your thesis, but five minutes before starting you
    opened Instagram for two hours 😵‍💫).
    <br />
    This doesn't mean it prevents you from engaging in “non-productive” activities. If you want to scroll
    through TikTok for four hours, that's fine, just schedule it in Zen and you're good to go.
  </p>
  <p>
  ...
  <ol class="flex flex-col gap-4 pl-4 list-decimal list-outside sm:pl-12 marker:font-bold">
    ...
    <li>
      ...
      <div class="p-4 my-4 rounded-xl glass text-red-800/80">
        ...
        that renders Zen ineffective.
        <br />
        If, for any reason, you need to depart from the plan, see <b>3.</b> but <b>NEVER</b> misuse start
        or stop!
      </div>
    </li>
    <li>
      <p>
        For unplanned or spontaneous changes, open the <a href="/planner" class="underline"
          >Zen Planner</a
  ...
  <p>
    By following these steps, Zen guides you through the day and provides rated feedback 📊 that
    rewards strict adherence to your plan (especially when it's precise and detailed).
    <br />
    The <a href="/leaderboard" class="underline">Zen Leaderboard</a> 🏆 compares your rating with others;
