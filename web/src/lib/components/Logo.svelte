<div class="glass flex justify-center items-center p-20 w-min h-min rounded-2xl">
  <svg class="logo w-40 h-40 lg:w-96 lg:h-96 xl:w-[588px] xl:h-[588px]" viewBox="0 0 588 583" fill="none" xmlns="http://www.w3.org/2000/svg">
